...
/**
* FUNCTION TheHostBoy_getConfigArray()
* @param array $params
* @return array $return
*/
function TheHostBoy_getConfigArray() {
	$configarray = array(
		...
		"api_email" => array(
			...
			"Type"          => "text",
			"Size"          => "40",
			"Description"   => "Enter your email at THEHOSTBOY WEB HOSTING"
		),
		"api_key" => array(
			"FriendlyName"  => "API Key",
			"Type"          => "text",
			"Size"          => "40",
			"Description"   => "Enter your THEHOSTBOY WEB HOSTING Domains API key"
		),
	);
	return $configarray;
}
...
/**
* FUNCTION TheHostBoy_RegisterDomain()
* Register Domain
* @param array $params
* @return array $return
*/
function TheHostBoy_RegisterDomain($params)
{
	$API = new TheHostBoy_API($params['api_email'], $params['api_key']);
        $requeststring = array(
...
/**
* FUNCTION TheHostBoy_TransferDomain()
* Transfer Domain
* @param array $params
* @return array $return
*/
function TheHostBoy_TransferDomain($params)
{
	$API = new TheHostBoy_API($params['api_email'], $params['api_key']);
        $requeststring = array(
...
/**
* FUNCTION TheHostBoy_RenewDomain
* Renew Domain
* @param array $params
* @return array $return
*/
function TheHostBoy_RenewDomain($params) {
	$API = new TheHostBoy_API($params['api_email'], $params['api_key']);
...
/**
* FUNCTION TheHostBoy_getNameserver
* Get name servers
* @param array $params
* @return array $return
*/
function TheHostBoy_GetNameservers($params){
        $API  = new TheHostBoy_API($params['api_email'], $params['api_key']);
...
/**
* FUNCTION TheHostBoy_SaveNameservers
* Save nameservers
* @param array $params
* @return array $return
*/
function TheHostBoy_SaveNameservers($params){
    $API  = new TheHostBoy_API($params['api_email'], $params['api_key']);
    $data = $API->simpleCall('POST', array(
...
/**
* FUNCTION TheHostBoy_ReleaseDomain
* Release Domain
* @param array $params
* @return array $return
*/
function TheHostBoy_ReleaseDomain($params){
    $API  = new TheHostBoy_API($params['api_email'], $params['api_key']);
    $data = $API->simpleCall('POST', array(
...
/**
* FUNCTION TheHostBoy_getEPPCode
* Get EPP Code
* @param array $params
* @return array $return
*/
function TheHostBoy_GetEPPCode($params){
    $API  = new TheHostBoy_API($params['api_email'], $params['api_key']);
    $data = $API->simpleCall('POST', array(
            'action'		=> 'GetEPPCode',
            'sld'		=> $params["sld"],
...
/**
* FUNCTION TheHostBoy_getContactDetails
* Get Contact Details
* @param array $params
* @return array $return
*/
function TheHostBoy_GetContactDetails($params){
    $API  = new TheHostBoy_API($params['api_email'], $params['api_key']);
    $data = $API->simpleCall('POST', array(
...
/**
* FUNCTION TheHostBoy_SaveContactDetails
* Save Contact Details
* @param array $params
* @return array $return
*/
function TheHostBoy_SaveContactDetails($params){
    $new = array();
...
/**
* FUNCTION TheHostBoy_GetDomainFields
...
function TheHostBoy_GetDomainFields(){
    ...
    $query = PdoWrapper::query("SELECT `setting`,`value` FROM `tblregistrars` WHERE `registrar`='TheHostBoy'");
    $params = array();
...
/**
* FUNCTION TheHostBoy_getRegistrarLock
* Get Lock Status
* @param array $params
* @return array $return
*/
function TheHostBoy_GetRegistrarLock($params){
    $API  = new TheHostBoy_API($params['api_email'], $params['api_key']);
    $data = $API->simpleCall('POST', array(
...
/**
* FUNCTION TheHostBoy_SaveRegistrarLock
* Update Lock Status
* @param array $params
* @return array $return
*/
function TheHostBoy_SaveRegistrarLock($params){
    $API  = new TheHostBoy_API($params['api_email'], $params['api_key']);
    $data = $API->simpleCall('POST', array(
...
/**
* FUNCTION TheHostBoy_GetDNS
* Get DNS Records
* @param array $params
* @return array $return
*/
function TheHostBoy_GetDNS($params){
    $API  = new TheHostBoy_API($params['api_email'], $params['api_key']);
    $data = $API->simpleCall('POST', array(
            'action'		=> 'GetDNS',
            'sld'		=> $params["sld"],
...
/**
* FUNCTION TheHostBoy_SaveDNS
* Save DNS Records
* @param array $params
* @return array $return
*/
function TheHostBoy_SaveDNS($params){
    $API  = new TheHostBoy_API($params['api_email'], $params['api_key']);
    $data = $API->simpleCall('POST', array(
            'action'		=> 'SaveDNS',
            'sld'		=> $params["sld"],
...
/**
* FUNCTION TheHostBoy_RegisterNameserver
* Register Name Server
* @param array $params
* @return array $return
*/
function TheHostBoy_RegisterNameserver($params){
    $API  = new TheHostBoy_API($params['api_email'], $params['api_key']);
    $data = $API->simpleCall('POST', array(
...
/**
* FUNCTION TheHostBoy_ModifyNameserver
* Update Name Server
* @param array $params
* @return array $return
*/
function TheHostBoy_ModifyNameserver($params){
    $API  = new TheHostBoy_API($params['api_email'], $params['api_key']);
    $data = $API->simpleCall('POST', array(
...
/**
* FUNCTION TheHostBoy_DeleteNameserver
* Delete Name Server
* @param array $params
* @return array $return
*/
function TheHostBoy_DeleteNameserver($params){
    $API  = new TheHostBoy_API($params['api_email'], $params['api_key']);
    $data = $API->simpleCall('POST', array(
...
/**
* FUNCTION TheHostBoy_RequestDelete
* Delete Domain
* @param array $params
* @return array $return
*/
function TheHostBoy_RequestDelete($params){
    $API  = new TheHostBoy_API($params['api_email'], $params['api_key']);
    $data = $API->simpleCall('POST', array(
...
/**
* FUNCTION TheHostBoy_TransferSync
* Synchronize transfer domain
* @param array $params
* @return array $return
*/
function TheHostBoy_TransferSync($params) {
    $API  = new TheHostBoy_API($params['api_email'], $params['api_key']);
    $data = $API->simpleCall('POST', array(
            'action'		=> 'TransferSync',
            'sld'		=> $params["sld"],
...
/**
* FUNCTION TheHostBoy_Sync
* Synchronize Registered Domains
* @param array $params
* @return array $return
*/
function TheHostBoy_Sync($params) {
    $API  = new TheHostBoy_API($params['api_email'], $params['api_key']);
    $data = $API->simpleCall('POST', array(
            'action'		=> 'Sync',
            'sld'		=> $params["sld"],
...
/**
* FUNCTION TheHostBoy_GetEmailForwarding
* Get list of emails aliases
* @param array $params
* @return array $return
*/
function TheHostBoy_GetEmailForwarding($params)
  {
    $API  = new TheHostBoy_API($params['api_email'], $params['api_key']);
    $data = $API->simpleCall('POST', array(
...
/**
* FUNCTION TheHostBoy_SaveEmailForwarding
* Save list of emails aliases
* @param array $params
* @return array $return
*/
function TheHostBoy_SaveEmailForwarding($params)
{
    $API  = new TheHostBoy_API($params['api_email'], $params['api_key']);
    $data = $API->simpleCall('POST', array(
...
/**
* FUNCTION TheHostBoy_IDProtectToggle
* This function is called when the ID Protection setting is toggled on or off
* @param array $params
* @return array $return
*/
function TheHostBoy_IDProtectToggle($params)
{
    $API  = new TheHostBoy_API($params['api_email'], $params['api_key']);
    $data = $API->simpleCall('POST', array(
